...
<section class="properSale_area" id="propertySale">
    <div class="container">
        ...
        if(isset($_SESSION['error_type'])){
            if($_SESSION['error_type']=='success'){?>
                <div data-form-alert="true">
                    <div data-form-alert-success="false" class="alert alert-form alert-success text-xs-center"><?php echo $_SESSION['error_message']; ?></div>
                </div>
            <?php
            }
            else if($_SESSION['error_type']=='fail'){?>
                <div data-form-alert="true">
                    <div data-form-alert-success="false" class="alert alert-form alert-danger text-xs-center"><?php echo $_SESSION['error_message']; ?></div>
                </div>
            <?php
            }
            $_SESSION['error_type']='';
        ...
        <div class="prperySaleForm">
            <form action="action.php" id="prperysale" method="post">
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label class="form-control-label" for="agencyName">Agency name<span class="form-asterisk">*</span></label>
                            <input type="text" class="form-control" name="agency_name" id="agencyName" required="" placeholder="Agency Name" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label class="form-control-label" for="AMIlicence">AMI licence nº<span class="form-asterisk">*</span></label>
                            <input type="text" class="form-control" name="ami_licence" id="AMIlicence" required="" placeholder="AMI licence nº" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label class="form-control-label" for="Name-propert">Name<span class="form-asterisk">*</span></label>
                            <input type="text" class="form-control" name="agent_name" id="Name-propert" required="" placeholder="Agent Name" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label class="form-control-label" for="Email-property">Email<span class="form-asterisk">*</span></label>
                            <input type="text" class="form-control" name="email_agent" id="Email-property" required="" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-12">
                        <div class="form-group">
                            <label class="form-control-label" for="Contact-contact">Contact<span class="form-asterisk">*</span></label>
                            <input type="text" class="form-control" name="contact_us_txt" id="Contact-contact" required="" >
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
